...
| `gpu_peer::linalg`    | SIMT       | House-owned f64 batched einsum, GEMM, Jacobi symmetric-eig and Jacobi SVD kernels over resident VRAM blocks (driver-JIT PTX, no vendor library), each with a CPU reference and an `accel_op` registration |
